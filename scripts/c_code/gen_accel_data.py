...
#
# This mirrors the methodology of scripts/c_code/main_gemm.c (random signed
...
#
# Usage:
#   python3 scripts/c_code/gen_accel_data.py [--seed N]
...
/*
 * Auto-generated by scripts/c_code/gen_accel_data.py (seed 0x{args.seed:X}).
